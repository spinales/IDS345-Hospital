                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="text-muted mb-0">
                                <asp:Label ID="lblNombreServicio" runat="server" Text="Label"></asp:Label>
                            </p>
                        </div>
                    </div>
                </td>
                            ...
                            <div class="d-flex flex-column dis">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <p>
                                        <span class="fas fa-dollar-sign"></span>
                                        <p class="fw-regular mb-1">
                                            <asp:Label ID="lblSumaIMpuestos" runat="server" Text="Label"></asp:Label>
                                        </p>
                                    </p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="btn btn-primary mt-2">
                                    Pagar<span class="fas fa-dollar-sign px-1"></span>
                                    <p class="fw-bold mb-1 d-inline">
                                        <asp:Label ID="lblCuenta" runat="server" Text="Label"></asp:Label>
                                    </p>
                                </div>
                            </div>
                        </div>
