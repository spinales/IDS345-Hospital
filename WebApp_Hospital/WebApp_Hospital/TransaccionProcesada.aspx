                ...
                <div class="row text-center">
                    <ul class="list-unstyled">
                        ...
                        <li class="text-muted mt-1">
                            <i class="fas fa-circle-check fa-2xl" style="color: #25c11a;"></i>
                        </li>
                    ...
                    <div class="d-flex justify-content-around">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <asp:Label ID="lblCuneta" runat="server" Text="Label"></asp:Label>
                            </li>
                            <li>
                                <asp:Label ID="lblFechaPago" runat="server" Text="Label"></asp:Label>
                            </li>
                            <li>
                                <asp:Label ID="lblEstadoTransaccion" runat="server" Text="Label"></asp:Label>
                            </li>
                            <li>
