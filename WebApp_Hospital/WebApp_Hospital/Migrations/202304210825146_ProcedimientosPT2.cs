    ...
    public partial class Procedimientos : DbMigration
    {
        public override void Up()
        {
            Sql(@"CREATE PROCEDURE sp_registrar_factura
                ...
                AS
                BEGIN
                    INSERT INTO Factura(TotalFinal, TotalDescuento, TotalBruto, CuentaID, PacienteID, EmpleadoID, MetodoPagoID, CreatedAt, Estado, CodigoFactura)
                    VALUES (@TotalFinal, @TotalDescuento, @TotalBruto, @CuentaID, @PacienteID, @EmpleadoID, @MetodoPagoID, @CreatedAt, 1, @CodigoFactura);
            ...
            Sql(@"CREATE OR ALTER PROCEDURE sp_registrar_factura_servicio
                ...
                BEGIN
                    ...
                    INSERT INTO FacturaServicios(PrecioUnitario, Cantidad, Impuesto, Descuento, TotalImpuesto, TotalDescuento, TotalBruto, TotalFinal, Descripcion, CreatedAt, ServicioID, FacturaID)
                    VALUES (@PrecioUnitario, @Cantidad, @Impuesto, @Descuento, @TotalImpuesto, @TotalDescuento, @TotalBruto, @TotalFinal, @Descripcion, @CreatedAt, @ServicioID, @FacturaID);
            ...
            Sql(@"CREATE OR ALTER PROCEDURE sp_registrar_consulta 
                ...
                BEGIN
                    ...
                    INSERT INTO Consulta(DoctorID, Descripcion, CreatedAt, DetalleId)canal
